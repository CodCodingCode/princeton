...
def _render_header(case: PatientCase, styles) -> list:
    ...
    out: list = []
    out.append(Paragraph("Onkos Automated Oncology Consult Summary", styles["Title"]))
...
def _render_signature(styles) -> list:
    ...
    out.append(_P_raw(
        "Generated by Onkos. Not a substitute for a licensed oncologist.",
        styles,
    ))
    return out
...
def build_report_pdf(
    ...
    *,
    ...
    doc = SimpleDocTemplate(
        buf,
        pagesize=LETTER,
        title=f"Onkos consult summary: case {case.case_id}",
        author="Onkos",
